...
var Pzh = function (hostname) {
    ...
    PzhObject.checkConnectedDevices= function(id) {
        console.log(id, pzh_state.connectedDevicesToOtherPzh);
...
//                }
                ...
                PzhObject.syncAllPzp(pzpId, {"connectedDevices": PzhObject.getConnectedDevices()});
                PzhObject.syncAllPzh(undefined, {"connectedDevices": {pzp:PzhObject.getConnectedDevices("pzp")}});
        ...
        if (pzhId) {
            ...
            //if (!pzh_state.connectedPzh.hasOwnProperty(pzhId)) {
               ...
               // PzhObject.registerServices(pzhId);
                ...
                PzhObject.syncAllPzp(undefined, {"connectedDevices": PzhObject.getConnectedDevices()});
                PzhObject.syncAllPzh(pzhId, {"connectedDevices": {pzp:PzhObject.getConnectedDevices("pzp")}});
