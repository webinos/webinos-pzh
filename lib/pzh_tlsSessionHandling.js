...
var Pzh = function (hostname) {
     ...
     */
    this.handleConnectionAuthorization = function (conn, client) {
        ...
        if (conn.authorized && config.cert.validateConnection(peerCert.issuer.CN, getCAList())) {// PZP/PZH connecting with proper certificate at both ends
            var cn, name;
            ...
            if (cn[0] === "Pzh") {
                ...
                PzhObject.handlePzhAuthorization (name, conn, client);
            } else if (cn[0] === "Pzp") {
