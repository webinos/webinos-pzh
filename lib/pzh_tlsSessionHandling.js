...
var Pzh = function () {
     ...
     * @param _uri pzh url you want to add, assumption it is of form bob@pzh.webinos.org
    ...
    this.addLoadPzh = function (_friendlyName, _uri, _user) {
        try {
            ...
            self.pzh_state.logger.addId (self.config.userData && self.config.userData.nickname && self.config.userData.email[0].value);
