...
var Pzh = function () {
    ...
    PzhObject.getConnectedPzh = function()   {return pzh_state.connectedPzh; };
    PzhObject.getConnectedPzp = function()   {return pzh_state.connectedPzp; };
    PzhObject.getExternalPzh  = function(to) {return config.cert.external[to];};
    PzhObject.getTrustedList  = function()   {return config.trustedList; };
    PzhObject.getSignedCert   = function(id) {return config.cert.internal.signedCert[id]; };
    PzhObject.getPzhMasterCertificate = function() {return config.cert.internal.master.cert; };
    PzhObject.getPzhCRL       = function()   {return config.cert.crl; };
    PzhObject.getFriendlyName = function()   {return config.metaData.friendlyName; };

    PzhObject.revokeClientCert= function(id) {
        var crl = config.cert.revokeClientCert(id);
        config.crl.value = crl;
    ...
    PzhObject.clearConnectedDeviceDetails = function(id) {
       if(pzh_state.connectedPzh.hasOwnProperty(id)) delete pzh_state.connectedPzh[id];
       if(pzh_state.connectedPzp.hasOwnProperty(id)) delete pzh_state.connectedPzp[id];
