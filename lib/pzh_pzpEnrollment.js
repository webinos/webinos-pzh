...
var Pzh_pzpEnroll = function () {
     ...
     */
    this.addNewPZPCert = function (messageReceived, refreshCert, remoteIP) {
        try {
            var friendlyName;
            ...
            if (PzhObject.checkTrustedList(pzpId)) {
                ...
                if (PzhObject.checkTrustedList(pzpId)) {
                    ...
                    msg = PzhObject.prepMsg(messageReceived.message.from, "pzpId_Update", messageReceived.message.from+"_"+randId);
                    return msg;
                }
            ...
            friendlyName = (!PzhObject.checkFriendlyName(messageReceived.message.friendlyName)) ?
                messageReceived.message.friendlyName: messageReceived.message.friendlyName + " " +messageReceived.message.from;

            if(PzhObject.signStorePzpCertificate(pzpId, friendlyName, messageReceived.message.csr, remoteIP)){
