...
var Pzh_pzpEnroll = function () {
    ...
    this.addNewPZPCert = function (messageReceived, refreshCert) {
        try {
            ...
            if (PzhObject.getTrustedList().pzp[pzpId]) {
            ...
            if(PzhObject.signStorePzpCertificate(pzpId, messageReceived.message.friendlyName, messageReceived.message.csr)){
                ...
                var payload = {"clientCert":PzhObject.getSignedCert(pzpId),
                    "masterCert":PzhObject.getPzhMasterCertificate(),
                    "masterCrl" :PzhObject.getPzhCRL(),
