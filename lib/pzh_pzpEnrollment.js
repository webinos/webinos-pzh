...
var Pzh_pzpEnroll = function () {
    ...
    this.addNewPZPCert = function (messageReceived, refreshCert) {
        try {
            ...
            var deviceType = messageReceived.message.deviceType ? messageReceived.message.deviceType : 'unknown';

            if(PzhObject.signStorePzpCertificate(pzpId, friendlyName, deviceType, messageReceived.message.csr)){
